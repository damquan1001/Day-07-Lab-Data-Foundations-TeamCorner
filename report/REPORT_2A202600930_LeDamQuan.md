...
|-----------|----------|----------------------|-----------|----------|
| Tôi | Article-level + Hybrid BM25/Vector | 10/10 trên 5 benchmark queries | Bám cấu trúc luật, truy xuất đúng điều | Phụ thuộc vào heading/metadata rõ ràng |
| [Tên] | | | | |
| [Tên] | | | | |

**Strategy nào tốt nhất cho domain này? Tại sao?**  
> [Để trống - phần so sánh nhóm]
